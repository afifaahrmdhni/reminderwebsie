...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8">
                        <div class="px-6 py-4 border-b border-gray-200">
                            <h3 class="text-lg font-semibold text-gray-800">Tambah Product Baru</h3>
                        </div>
                        ...
                        <div class="p-6">
                            <form id="user-form" class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        <label for="nama-product" class="block text-sm font-medium text-gray-700 mb-2">Product</label>
                                        <input type="text" id="nama-product" name="product" required
                                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                               placeholder="Nama product">
                                    </div>
                                    
                                    <div>
                                        <label for="no-whatsapp" class="block text-sm font-medium text-gray-700 mb-2">No. Whatsapp</label>
                                        <input type="tel" id="whatsapp" name="no-whatsapp" required
                                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                               placeholder="+62xxx">
                                    </div>
 ...
 <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        <div class="px-6 py-4 border-b border-gray-200">
                            <h3 class="text-lg font-semibold text-gray-800">Daftar Product</h3>
                        </div>
